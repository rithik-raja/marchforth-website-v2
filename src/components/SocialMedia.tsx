...
export const socialMediaProfiles = [
  { title: 'LinkedIn', href: 'https://www.linkedin.com/company/marchforth-corporation', icon: LinkedInIcon },
  { title: 'GitHub', href: 'https://github.com/rithik-raja', icon: GitHubIcon },
]
